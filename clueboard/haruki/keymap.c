...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
[_BL] = LAYOUT(
  KC_ESC,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_NO, KC_BSPC,         KC_PGUP,
  KC_TAB, KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,KC_RBRC,KC_NO,                  KC_PGDN,
  TD(TD_CAPS),KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L, LT(LAYER2,KC_SCLN), TD(TD_END),KC_BSLS, CTL_T(KC_ENT),
  SC_LSPO,KC_NUBS,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH, KC_NO, SC_RSPC,        KC_UP,
...
[_FL] = LAYOUT(
   ...
   */
[_CL] = LAYOUT(
  BL_STEP,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______, _______,UG_TOGG,     UG_NEXT,
  ...
  _______,_______,_______,_______,_______,                   _______,_______,            _______,MO(_FL),_______,UG_HUED,UG_SATD,UG_HUEU),
