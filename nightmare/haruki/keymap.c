...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split(/* Base */
                 ...
                 KC_PGUP, SC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLSH, SC_RSPC, MO(1),
    ...
    [2] = LAYOUT_split(
        _______, _______, LSFT(KC_1),LSFT(KC_2),LSFT(KC_3),LSFT(KC_4),LSFT(KC_5),LSFT(KC_6),LSFT(KC_7),LSFT(KC_8),LSFT(KC_9),LSFT(KC_0), LSFT(KC_MINS), LSFT(KC_EQL), LSFT(KC_NO),
        _______, _______, DE_LABK,DE_RABK,DE_LCBR,DE_RCBR,DE_LBRC,DE_RBRC,KC_HOME,KC_END,KC_DEL  , KC_LEFT, KC_RIGHT, _______,
    ...
    [3] = LAYOUT_split(
        ...
        _______, _______, DE_LABK,DE_RABK,DE_LCBR,DE_RCBR,DE_LBRC,DE_RBRC,KC_4,KC_5,KC_6  , KC_LEFT, KC_RIGHT, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_1, KC_2, KC_3, KC_DOWN, _______, _______,
        _______, _______, _______, _______, _______, KC_0, _______, QK_BOOT, _______),
    [4] = LAYOUT_split(
        ...
        _______, _______, DE_ADIA,DE_RABK,DE_LCBR,DE_RCBR,DE_LBRC,DE_RBRC,KC_4,KC_5,KC_6  , KC_LEFT, KC_RIGHT, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_1, KC_2, KC_3, KC_DOWN, _______, _______,
        _______, _______, _______, _______, _______, KC_0, _______, QK_BOOT, _______)};
