...
[KM_QWERTY] = LAYOUT( \
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                LT(MISC1,KC_INS), KC_DEL, KC_SPC,         KC_RALT, KC_RCTL,   KC_LEFT, KC_DOWN, KC_RGHT                   \
    ),

[MISC1] = LAYOUT(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, _______,_______,
        KC_TRNS, UG_TOGG, UG_NEXT, UG_HUED, UG_HUEU, UG_SATD, UG_SATU, KC_7, KC_8, KC_9, KC_0, _______, _______, _______,_______,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_4, KC_5, KC_6, KC_TRNS, KC_TRNS, KC_TRNS,_______,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, BL_DOWN, BL_TOGG, BL_UP,  BL_STEP, KC_1, KC_2, KC_3, KC_TRNS, KC_TRNS, KC_TRNS,_______,
