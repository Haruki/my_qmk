...
[KM_QWERTY] = LAYOUT( \
	...
	[LAYER2] = LAYOUT( \
		...
		_______,DE_LABK,DE_RABK,DE_LCBR,DE_RCBR,DE_LBRC,DE_RBRC,KC_HOME,KC_END,_______,_______,_______,        _______,                              _______,_______,_______        ,\
	...
	[MISC] = LAYOUT( \
		...
		_______,_______,_______,                        _______,                        _______,_______,QK_BOOT  ,_______,   KC_MPRV,KC_MSTP,KC_MNXT,  _______,_______                 )
};
