...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [KM_QWERTY] = LAYOUT_all(
    ...
    SC_LSPO, KC_NUBS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, SC_RSPC, KC_NO, //14 slots
  ...
  [MISC1] = LAYOUT_all(
    ...
    KC_TRNS, UG_TOGG, UG_NEXT, UG_HUEU, UG_HUED, UG_SATU, UG_SATD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, _______, _______, _______,
  ...
  [MISC2] = LAYOUT_all(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, ALGR(KC_NUBS), KC_4, KC_5, KC_6, KC_TRNS, KC_TRNS, KC_TRNS,
  ...
  [LAYER2] = LAYOUT_all( \
    ...
    _______,_______,_______,_______,_______,_______,_______,KC_BSLS,DE_QUOT,_______,_______,_______,_______,_______,   \
